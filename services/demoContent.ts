    ...
    1: {
      ...
      html: `
        <div class="flex h-screen overflow-hidden flex-col lg:flex-row">
          <!-- Desktop Sidebar -->
          <div class="hidden lg:flex w-64 bg-white border-r border-gray-200 p-6 flex-col">
            <div class="flex items-center gap-3 mb-10">
              <div class="w-8 h-8 bg-blue-600 rounded flex items-center justify-center text-white font-bold">P</div>
              <span class="font-bold text-lg">PetroPulse</span>
            </div>
            <nav class="space-y-1 flex-1">
              <div class="sidebar-item active" data-page="overview" onclick="showPage('overview', this)">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                Fleet Overview
              </div>
              <div class="sidebar-item" data-page="safety" onclick="showPage('safety', this)">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                Safety Audits
              </div>
              <div class="sidebar-item" data-page="compliance" onclick="showPage('compliance', this)">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                Compliance Logs
              </div>
              <div class="sidebar-item" data-page="fuel" onclick="showPage('fuel', this)">
          ...
          <div class="lg:hidden bg-white border-b border-gray-200 p-4 flex items-center justify-between">
            <div class="flex items-center gap-2">
              <div class="w-6 h-6 bg-blue-600 rounded flex items-center justify-center text-white font-bold text-xs">P</div>
              <span class="font-bold text-sm">PetroPulse</span>
            </div>
            <div class="flex gap-2 overflow-x-auto no-scrollbar pb-1">
              <button data-page="overview" onclick="showPage('overview', this)" class="mobile-nav-btn text-[10px] font-bold uppercase tracking-tight text-blue-600 px-2 py-1 bg-blue-50 rounded">Stats</button>
              <button data-page="safety" onclick="showPage('safety', this)" class="mobile-nav-btn text-[10px] font-bold uppercase tracking-tight text-gray-400 px-2 py-1">Safety</button>
              <button data-page="compliance" onclick="showPage('compliance', this)" class="mobile-nav-btn text-[10px] font-bold uppercase tracking-tight text-gray-400 px-2 py-1">Comp</button>
              <button data-page="fuel" onclick="showPage('fuel', this)" class="mobile-nav-btn text-[10px] font-bold uppercase tracking-tight text-gray-400 px-2 py-1">Fuel</button>
            </div>
          </div>

          <div class="flex-1 flex flex-col overflow-hidden">
            <header class="h-14 lg:h-16 bg-white border-b border-gray-200 px-4 lg:px-8 flex items-center justify-between shrink-0">
              <div class="flex items-center gap-4">
                <h2 class="text-sm lg:text-xl font-medium" id="page-title">Fleet Overview</h2>
                <div class="hidden sm:block status-chip bg-blue-50 text-blue-700 text-[9px] tracking-widest font-bold uppercase">CALGARY</div>
              </div>
              <div class="flex items-center gap-2 lg:gap-4">
                <div class="status-chip bg-green-100 text-green-700 text-[10px]" id="efficiency-pill">98% Efficient</div>
              </div>
            </header>

            <main class="flex-1 p-4 lg:p-8 space-y-6 lg:space-y-8 overflow-y-auto" id="main-content">
              <!-- OVERVIEW PAGE -->
              <div id="page-overview" class="space-y-6 lg:space-y-8">
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6">
                  <div class="md-card p-4 lg:p-6">
                    <p class="text-[10px] font-bold text-gray-500 uppercase mb-1">Active Units</p>
                    <p class="text-xl lg:text-3xl font-bold" id="active-units">42 <span class="text-xs font-normal text-gray-400">/ 45</span></p>
                  </div>
                  <div class="md-card p-4 lg:p-6">
                    <p class="text-[10px] font-bold text-gray-500 uppercase mb-1">Fuel Burn</p>
                    <p class="text-xl lg:text-3xl font-bold text-blue-600" id="fuel-burn">34.2 <span class="text-xs">L/h</span></p>
                  </div>
                  <div class="md-card p-4 lg:p-6">
                    <p class="text-[10px] font-bold text-gray-500 uppercase mb-1">Incident Score</p>
                    <p class="text-xl lg:text-3xl font-bold text-green-600">0.02</p>
                  </div>
                  <div class="md-card p-4 lg:p-6 bg-blue-600 text-white">
                    <p class="text-[10px] font-bold opacity-80 uppercase mb-1">Status</p>
                    <p class="text-xl lg:text-3xl font-bold uppercase">OPTIMAL</p>
                  </div>
                </div>

                <div class="md-card p-0 h-[300px] lg:h-[450px] relative overflow-hidden calgary-map-container">
                  <!-- Stylized City Grid Background -->
                    ...
                    <svg width="100%" height="100%" viewBox="0 0 1000 1000" preserveAspectRatio="xMidYMid slice" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <pattern id="grid-pattern" width="30" height="30" patternUnits="userSpaceOnUse">
                          <path d="M 30 0 L 0 0 0 30" fill="none" stroke="rgba(0,0,0,0.2)" stroke-width="0.5"/>
                        </pattern>
                      </defs>
                  ...
                  <!-- High Quality Vector Streets -->
                  <svg class="absolute inset-0 w-full h-full opacity-40" viewBox="0 0 1000 1000" preserveAspectRatio="xMidYMid slice" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <!-- Bow River -->
                    <path d="M0 200 C 250 220, 450 300, 520 450 C 580 600, 700 850, 1000 950" stroke="#bae6fd" stroke-width="60" stroke-linecap="round" opacity="0.4" />
                    
                    <!-- Major Arterials (Highways) -->
                    <path d="M540 0 V1000" stroke="#94a3b8" stroke-width="15" /> <!-- Deerfoot Trail -->
                    <path d="M0 680 H1000" stroke="#94a3b8" stroke-width="12" /> <!-- Glenmore Trail -->
                    <path d="M0 350 H1000" stroke="#94a3b8" stroke-width="8" /> <!-- 16th Ave N -->
                    <path d="M300 0 V1000" stroke="#cbd5e1" stroke-width="12" /> <!-- Crowchild Trail -->
                    <path d="M0 100 L1000 900" stroke="#e2e8f0" stroke-width="8" opacity="0.5" /> <!-- Stoney Trail / East -->
                    
                    <!-- Downtown / Secondary Grid -->
                    <g opacity="0.2">
                       <path d="M420 350 V600" stroke="#94a3b8" stroke-width="2" />
                       <path d="M440 350 V600" stroke="#94a3b8" stroke-width="2" />
                       <path d="M460 350 V600" stroke="#94a3b8" stroke-width="2" />
                       <path d="M480 350 V600" stroke="#94a3b8" stroke-width="2" />
                       <path d="M500 350 V600" stroke="#94a3b8" stroke-width="2" />
                       <path d="M400 400 H540" stroke="#94a3b8" stroke-width="2" />
                       <path d="M400 420 H540" stroke="#94a3b8" stroke-width="2" />
                       <path d="M400 440 H540" stroke="#94a3b8" stroke-width="2" />
                    </g>
                  </svg>

                  <!-- Dynamic Map Labels -->
                  <div class="map-label" style="top: 5%; left: 56%;">Deerfoot Tr</div>
                  <div class="map-label" style="top: 69%; left: 5%;">Glenmore Tr</div>
                  <div class="map-label" style="top: 36%; left: 5%;">16th Ave N</div>
                  <div class="map-label" style="top: 10%; left: 32%;">Crowchild Tr</div>
                  <div class="map-label" style="top: 45%; left: 45%; color: #0ea5e9; font-weight: bold; background: none;">Bow River</div>

                  <!-- Unit Marker -->
                  <div class="pulse-container" style="top: 25%; left: 54%; color: var(--md-success);" id="truck-402-marker">
                    <div class="pulse-dot"></div>
                    <div class="absolute top-full left-0 mt-2 bg-white p-2 rounded shadow-xl text-[10px] font-bold border border-gray-100 w-32 z-50">
                      UNIT: TRUCK-402
                      <br/><span class="text-gray-400 font-normal">Speed: <span id="truck-402-speed">102</span> km/h</span>
                    </div>
                  </div>
                </div>

                <div class="md-card p-4 lg:p-6">
                  <h3 class="font-bold text-sm lg:text-base mb-4 flex items-center justify-between">Alerts</h3>
                  <div class="space-y-3" id="alerts-container">
                    <div class="flex items-center justify-between p-3 bg-red-50 border border-red-100 rounded-lg" id="alert-1">
                      <div class="flex items-center gap-3">
                        <div class="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center text-red-600 font-black text-xs">!</div>
                        <div>
                          <span class="text-xs font-bold text-red-900 block">Unit TRUCK-210: Brake Pressure</span>
                        </div>
                      </div>
                      <button class="md-button md-button-primary bg-red-600 text-[10px] h-8" onclick="dispatchTech('alert-1')">Dispatch</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <!-- SAFETY AUDITS PAGE -->
              <div id="page-safety" class="hidden space-y-6 lg:space-y-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3 lg:gap-6">
                  <div class="md-card p-4 lg:p-6 text-center lg:text-left">
                    <p class="text-[10px] font-bold text-gray-500 uppercase mb-2">Rating</p>
                    <p class="text-3xl lg:text-4xl font-bold text-green-600">A+</p>
                  </div>
                </div>
                <div class="md-card p-0 overflow-x-auto">
                  <table class="w-full text-left min-w-[500px]">
                    <thead class="bg-gray-50 text-[9px] font-bold text-gray-400 uppercase tracking-widest">
                      <tr>
                    ...
                    <tbody class="divide-y divide-gray-100 text-xs">
                      <tr>
                        <td class="px-4 py-4 font-bold">TRUCK-402</td>
                        <td class="px-4 py-4">D. Sterling</td>
                        <td class="px-4 py-4">98/100</td>
                        <td class="px-4 py-4"><span class="status-chip bg-green-100 text-green-700">PASS</span></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <div id="page-compliance" class="hidden space-y-6 lg:space-y-8">
                <div class="md-card p-4 lg:p-6 bg-blue-600 text-white">
                  <h3 class="font-bold text-lg mb-2">Regulatory Compliance</h3>
                  <p class="text-xs opacity-80 mb-4">NSC Standards Active.</p>
                  <button class="bg-white text-blue-600 px-4 py-2 rounded font-bold text-[10px] uppercase">Export Audit</button>
                </div>
              </div>

              <!-- FUEL ANALYTICS PAGE -->
              <div id="page-fuel" class="hidden space-y-6 lg:space-y-8">
                <div class="md-card p-4 lg:p-8">
                   <h3 class="font-bold mb-4 text-sm">Fuel Usage (30d)</h3>
                   <div class="h-40 w-full flex items-end gap-1">
                     ${[40, 60, 45, 90, 80, 55, 70, 85, 95, 100, 75, 60, 50, 40].map((v, i) => `
                        <div class="bg-blue-500 rounded-t w-full" style="height: ${v}%"></div>
                     `).join('')}
                   </div>
                </div>
              </div>
        ...
        <script>
          function showPage(pageId, btn) {
            const titles = { 'overview': 'Fleet Overview', 'safety': 'Safety Audits', 'compliance': 'Compliance Logs', 'fuel': 'Fuel Analytics' };
            document.getElementById('page-title').innerText = titles[pageId];
            
            // Switch Page Visibility
            ['page-overview', 'page-safety', 'page-compliance', 'page-fuel'].forEach(p => document.getElementById(p).classList.add('hidden'));
            document.getElementById('page-' + pageId).classList.remove('hidden');
            
            // Sync Desktop Sidebar Active State
            document.querySelectorAll('.sidebar-item').forEach(i => i.classList.remove('active'));
            const desktopMatch = document.querySelector('.sidebar-item[data-page="' + pageId + '"]');
            if (desktopMatch) desktopMatch.classList.add('active');
            
            // Sync Mobile Nav Active State
            document.querySelectorAll('.mobile-nav-btn').forEach(b => {
                b.classList.remove('text-blue-600', 'bg-blue-50', 'rounded');
                b.classList.add('text-gray-400');
            });
            const mobileMatch = document.querySelector('.mobile-nav-btn[data-page="' + pageId + '"]');
            if (mobileMatch) {
                mobileMatch.classList.remove('text-gray-400');
                mobileMatch.classList.add('text-blue-600', 'bg-blue-50', 'rounded');
            }
          }
          function dispatchTech(id) {
            const el = document.getElementById(id);
            el.innerHTML = '<span class="text-[10px] font-bold text-green-700 uppercase p-2">Technician Dispatched...</span>';
            setTimeout(() => el.remove(), 2000);
          }
          setInterval(() => {
            const speedEl = document.getElementById('truck-402-speed');
            if (speedEl) speedEl.innerText = 95 + Math.floor(Math.random() * 15);
          }, 3000);
        </script>
      `
    },
